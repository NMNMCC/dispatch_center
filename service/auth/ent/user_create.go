...
func (_c *UserCreate) SetTokens(v []string) *UserCreate {
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.Tokens(); !ok {
		return &ValidationError{Name: "tokens", err: errors.New(`ent: missing required field "User.tokens"`)}
	}
	if v, ok := _c.mutation.Tokens(); ok {
...
// SetTokens sets the "tokens" field.
func (u *UserUpsert) SetTokens(v []string) *UserUpsert {
	u.Set(user.FieldTokens, v)
	return u
}

// UpdateTokens sets the "tokens" field to the value that was provided on create.
func (u *UserUpsert) UpdateTokens() *UserUpsert {
	u.SetExcluded(user.FieldTokens)
	return u
}
...
// SetTokens sets the "tokens" field.
func (u *UserUpsertOne) SetTokens(v []string) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetTokens(v)
	})
}
...
// UpdateTokens sets the "tokens" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateTokens() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateTokens()
	})
}
...
// SetTokens sets the "tokens" field.
func (u *UserUpsertBulk) SetTokens(v []string) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetTokens(v)
	})
}
...
// UpdateTokens sets the "tokens" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateTokens() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateTokens()
	})
}
