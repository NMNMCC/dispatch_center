...
func (_q *TaskQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*Task, init func(*Task), assign func(*Task, *Tag)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(tag.FieldID), joinT.C(task.TagsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(task.TagsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(task.TagsPrimaryKey[1]))
