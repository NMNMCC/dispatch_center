...
-- create "tasks" table
CREATE TABLE "tasks" ("id" uuid NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "status" character varying NOT NULL DEFAULT 'pending', "body" jsonb NOT NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "workers" ("id" uuid NOT NULL, "end_of_life" timestamptz NOT NULL, "task_worker" uuid NULL, PRIMARY KEY ("id"), CONSTRAINT "workers_tasks_worker" FOREIGN KEY ("task_worker") REFERENCES "tasks" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
